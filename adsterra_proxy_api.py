...
# Optional: set API key directly here or via environment
PROXY_API_KEY = os.getenv("PROXY_API_KEY") or "your_proxy_api_key_here"

def fetch_proxies_from_api():
    try:
        url = f"https://cracked.miami/proxy/?type=proxy&limit=100&key=d206380f58dd424d18a57fde4c02236a"
...
if __name__ == "__main__":
    ...
    proxy_pool = iter(proxy_list_shuffled * 10)
